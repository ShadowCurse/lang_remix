...
pub extern fn LoadDirectoryFiles(dirPath: [*c]const u8, count: [*c]c_int) [*c][*c]u8;
pub extern fn UnloadDirectoryFiles() void;
pub extern fn IsFileDropped() bool;
pub extern fn LoadDroppedFiles(count: [*c]c_int) [*c][*c]u8;
pub extern fn UnloadDroppedFiles() void;
...
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // raylib/src/raylib.h:114:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // raylib/src/raylib.h:117:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // raylib/src/raylib.h:120:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // raylib/src/raylib.h:123:13
